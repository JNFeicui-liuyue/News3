...
import contacts.feicui.edu.news3.model.httpclient.AsyncHttpClient;
import contacts.feicui.edu.news3.model.httpclient.JsonHttpResponseHandler;
...
public class SystemUtils {
    ...
    public String simType(){
        ...
        String type = "";if ("46000".equals(simOperator)){
            type = "移动";
    ...
    public void locatPosition(){
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 5000, 0, new
                LocationListener() {
